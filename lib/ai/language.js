...
const LANG_INSTRUCTIONS = {
  ...
  english:
    "Write your ENTIRE reply in English only. Do NOT use any Hindi, Hinglish or other-language words — no matter what language the sender or the examples used.",
  hindi:
  ...
  "english-slang":
    "Write your ENTIRE reply in casual English with modern texting slang (e.g. \"yooo\", \"ngl\", \"fr\", \"lol\", \"tbh\"). Do NOT use Hindi or Hinglish, no matter what language the sender used.",
};
