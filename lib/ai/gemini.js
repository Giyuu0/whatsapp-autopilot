...
// Hard timeout on every Gemini call so a hung request can't stall the
// serialized reply queue.
const REQUEST_OPTS = { timeout: 30000 };

// A "-latest" alias follows Google's current Flash-Lite, so a model retirement
// can't silently break this default the way gemini-2.0-flash did.
