...
const DEFAULTS = {
  settings: {
    ...
    // "Chatbot persona": when ON, replies adopt a charming/playful/emotionally
    // aware personality (built-in prompt) instead of the plain system prompt.
    chatbotPersona: false,
