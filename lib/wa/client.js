...
const { groqChat, groqVision, DEFAULT_CHAT_MODEL, DEFAULT_FAST_MODEL } = require("../ai/groq");
...
const UTILITY_MODEL = DEFAULT_FAST_MODEL;
...
- You previously worked in a hospital Cath Lab (Cardiology).
...
Mention that you worked in a hospital Cath Lab, where you assisted in procedures related to heart care, and that the experience taught you to stay calm under pressure and value meaningful human connections.
...
class WAController {
  ...
  primaryGroqModel() {
    ...
    return (step && step.model) || DEFAULT_CHAT_MODEL;
  }
