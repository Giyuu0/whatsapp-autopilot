...
class WAController {
  ...
  async hardenGetChats() {
    ...
    await this.client.pupPage.evaluate(() => {
      ...
      window.WWebJS.getChats = async () => {
        ...
        window.__skippedChats = settled.filter((r) => r.status === "rejected").length;
  ...
  async refreshChats() {
    ...
    try {
      ...
      if (skipped) console.warn(`[wa] ⚠ skipped ${skipped} chats whose data WhatsApp Web couldn't serialize (rest listed fine)`);
