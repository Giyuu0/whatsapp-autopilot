...
**This is the project's attribution requirement, not a courtesy.** Any deployment
other people can see must display legible credit to the author:
...
[`lib/attribution.js`](lib/attribution.js) and that is all.

> **A note on the check:** it is easy to delete, and you are free to modify this
> code. But the attribution requirement stands regardless of whether the check is
> present — removing the check does not remove the ask, it just means the software
> stops reminding you of it.
